...
const AppSidebar = () => {
  ...
  const navigation = getNavConfig(isArabic ? 'ar' : 'fr')
  ...
  return (
    <CSidebar
      ...
      style={{
        // Force l’emplacement du sidebar selon la langue
      ...
      <CSidebarBrand to="/">
        ...
        >
          {!logoError ? (
            <img 
              src={logoImage} 
              alt={isArabic ? 'شركة السلوق لدواجن' : 'Société Selougue de Volaille'}
              style={{
                height: 'auto',
                width: '100%',
                maxHeight: '50px',
            ...
            <div 
              style={{ 
                ...
                fontSize: '14px',
                fontWeight: '700',
                background: 'linear-gradient(90deg, #ef2b1d 0%, white 50%, #ef2b1d 100%)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
                backgroundClip: 'text'
              }}
            >
              {isArabic ? 'شركة السلوق لدواجن' : 'Société Selougue de Volaille'}
            </div>
          )}
        </div>
