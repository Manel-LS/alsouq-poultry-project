...
public class BatimentController : ControllerBase
{
    ...
    public async Task<IActionResult> List([FromQuery] string codeuser, [FromQuery] string cloturer = null)
    {
        ...
        // Log pour débogage
        Console.WriteLine($"Codeuser: {codeuser}, Cloturer: {cloturer}");
...
";
        ...
        if (!string.IsNullOrEmpty(cloturer))
        {
            ...
            Console.WriteLine($"SQL avec filtre: {sql}");
        }
        ...
        try
        {
            ...
            Console.WriteLine($"Nombre de résultats: {rows.Count()}");
        ...
        [FromQuery] string? codefact = null)
    {
        ...
        try
        {
            ...
            Console.WriteLine($"Exécution de la requête SQL avec codeuser: {codeuser}");
            ...
            Console.WriteLine($"Nombre de lignes récupérées: {rowsList.Count}");
        ...
        {
            Console.WriteLine($"Erreur dans ListBatimentsAvecMiseplace: {ex.Message}");
    ...
    public class DernierJourDto
    {
        ...
        public string TemperLot { get; set; }               // ttemperlot
        public string HumiditeLot { get; set; }             // thumiditelot
        public string ConseauLot { get; set; }              // tconseaulot
        public string IntLumLot { get; set; }               // tintlumlot
        public string EclairLot { get; set; }               // teclairlot
        public double StockOeuf { get; set; }               // calculated
        public double StockPlat { get; set; }               // calculated
        public string TypeEspece { get; set; }
        ...
        [FromQuery] int? currentJour = null)
    {
        try
        {
            ...
            {
                (stockOeuf, stockPlat) = await StockOeufLotAsync(db, numLot, /*codeDepBat*/ null, capaciteAlv);
            }
            ...
            var dto = new DernierJourDto
            {
                ...
                TemperLot = ttemperlot,
                HumiditeLot = thumiditelot,
                ConseauLot = tconseaulot,
                IntLumLot = tintlumlot,
                EclairLot = teclairlot,
                StockOeuf = stockOeuf,
                StockPlat = stockPlat,
    ...
    private async Task<bool> CheckArabicColumnsExist(IDbConnection db, string tableName, string[] columnNames)
    {
        try
        {
            ...
            return result != null && Convert.ToInt32(result.count) == columnNames.Length;
        }
        catch
        {
            return false;
