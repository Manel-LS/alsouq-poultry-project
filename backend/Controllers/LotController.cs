    ...
    public class LotController : ControllerBase
    {
            ...
            [FromQuery] double? tsemaine = null)
        {
            try
            {
                ...
                string lotNumber = !string.IsNullOrEmpty(tnummvt) ? tnummvt : numLot;
                ...
                string centreNumber = !string.IsNullOrEmpty(departement) ? departement : 
                                     (!string.IsNullOrEmpty(departmnt) ? departmnt : numCentre);
                ...
                await _context.Database.ExecuteSqlRawAsync($"USE `{nomBaseStockSession}`;");

                // Étape 3: Récupération des paramètres souche
                Console.WriteLine("=== RECHERCHE PARAM SOUCHE ===");
                ...
                Console.WriteLine("=== RECHERCHE PARAM SYSTÈME ===");
                ...
                Console.WriteLine("=== GESTION DÉPÔT ===");
                ...
                Console.WriteLine("=== RECHERCHE ESPÈCE ===");
                ...
                Console.WriteLine("=== STRUCTURE DE LA DONNÉE ===");
                ...
                Console.WriteLine("=== RECHERCHE JOUR CIBLE ===");
                ...
                Console.WriteLine("=== RÉCUPÉRATION EFFECTIF ===");
                ...
                Console.WriteLine("=== CALCUL VENTES ===");
                double tqtev = 0;
                double tpoidsv = 0;
                double tmtv = 0;
                ...
                Console.WriteLine("=== CALCUL STOCKS ===");
                double tstockoeuf = 0;
                double tstockplat = 0;
                ...
                Console.WriteLine("=== DTO CRÉÉ AVEC SUCCÈS ===");
            ...
            catch (Exception ex)
            {
                ...
                if (ex.InnerException != null)
                {
                    ...
                    Console.WriteLine($"STACK TRACE INTERNE: {ex.InnerException.StackTrace}");
                }
        ...
        private string SafeGetString(object value)
        {
            ...
            {
                Console.WriteLine($"Erreur dans SafeGetString: {ex.Message}");
                return string.Empty;
            }
        }
        ...
        private double SafeGetDouble(object value)
        {
            ...
            {
                Console.WriteLine($"Erreur dans SafeGetDouble: {ex.Message}");
                return 0.0;
            }
        }
